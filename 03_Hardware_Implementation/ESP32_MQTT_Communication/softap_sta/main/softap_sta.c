...
static void mqtt_app_start(void)
{
    const esp_mqtt_client_config_t mqtt_cfg = {
        .broker = {
            .address.uri = "mqtt://192.168.4.2:1883",
#if CONFIG_EXAMPLE_BROKER_CERTIFICATE_OVERRIDDEN
...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "Waiting for STA connection (10s)...");
    ...
    if (bits & WIFI_CONNECTED_BIT) {
        ...
        ESP_LOGW(TAG_STA, "STA Connection failed or timeout. Proceeding with SoftAP only.");
    ...
    ESP_LOGI("CHECK", "MQTT START SEED!!!");
    mqtt_app_start(); 
}
